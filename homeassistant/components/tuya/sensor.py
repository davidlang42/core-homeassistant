...
SENSORS: dict[str, tuple[TuyaSensorEntityDescription, ...]] = {
    ...
    "jtmspro": {
        TuyaSensorEntityDescription(
            key="ibeacon_switch",
            translation_key="ibeacon_switch",
        ),
        TuyaSensorEntityDescription(
            key="autolock_delay_level",
            translation_key="autolock_delay_level",
        ),
        TuyaSensorEntityDescription(
            key="rssi_sensitivity_level",
            translation_key="rssi_sensitivity_level",
        ),
        TuyaSensorEntityDescription(
            key="ibeacon_scan_mode",
            translation_key="ibeacon_scan_mode",
        ),
        TuyaSensorEntityDescription(
        ...
        TuyaSensorEntityDescription(
            key="unlock_double_kit",
            translation_key="unlock_double_kit",
        ),
        TuyaSensorEntityDescription(
            key="remote_pd_setkey_check",
            translation_key="remote_pd_setkey_check",
        ),
        TuyaSensorEntityDescription(
            key="unlock_record_check",
            translation_key="unlock_record_check",
        ),
        TuyaSensorEntityDescription(
            key="ble_unlock_check",
            translation_key="ble_unlock_check",
        ),
        TuyaSensorEntityDescription(
            key="check_code_set",
            translation_key="check_code_set",
        ),
        TuyaSensorEntityDescription(
            key="record",
        ...
        TuyaSensorEntityDescription(
            ...
            translation_key="unlock_offline_pd",
        ),
        TuyaSensorEntityDescription(
            key="unlock_offline_clear",
            translation_key="unlock_offline_clear",
        ),
        TuyaSensorEntityDescription(
            key="unlock_offline_clear_single",
            translation_key="unlock_offline_clear_single",
        ),
        TuyaSensorEntityDescription(
            key="password_offline_time",
            translation_key="password_offline_time",
        ),
        TuyaSensorEntityDescription(
        ...
        TuyaSensorEntityDescription(
            ...
            translation_key="temporary_password_modify",
        ),
        TuyaSensorEntityDescription(
            key="temporary_password_delete",
            translation_key="temporary_password_delete",
        ),
        TuyaSensorEntityDescription(
            key="synch_method",
            translation_key="synch_method",
        ),
        TuyaSensorEntityDescription(
            key="temporary_password_creat",
            translation_key="temporary_password_creat",
        ),
        TuyaSensorEntityDescription(
        ...
        TuyaSensorEntityDescription(
            key="lock_record",
            translation_key="lock_record",
        ),
        TuyaSensorEntityDescription(
            key="unlock_method_create",
            translation_key="unlock_method_create",
        ),
        TuyaSensorEntityDescription(
            key="unlock_method_delete",
            translation_key="unlock_method_delete",
        ),
        TuyaSensorEntityDescription(
            key="unlock_method_modify",
            translation_key="unlock_method_modify",
        ),
        TuyaSensorEntityDescription(
