...
class DPCode(StrEnum):
    ...
    TEMPORARY_PASSWORD_CREAT = "temporary_password_creat"
    TEMPORARY_PASSWORD_DELETE = "temporary_password_delete"
    TEMPORARY_PASSWORD_MODIFY = "temporary_password_modify"
    SYNCH_METHOD = "synch_method"
    ...
    PASSWORD_OFFLINE_TIME = "password_offline_time"
    UNLOCK_OFFLINE_CLEAR_SINGLE = "unlock_offline_clear_single"
    UNLOCK_OFFLINE_CLEAR = "unlock_offline_clear"
    UNLOCK_OFFLINE_PD = "unlock_offline_pd"
    RECORD = "record"
    CHECK_CODE_SET = "check_code_set"
    BLE_UNLOCK_CHECK = "ble_unlock_check"
    UNLOCK_RECORD_CHECK = "unlock_record_check"
    REMOTE_PD_SETKEY_CHECK = "remote_pd_setkey_check"
    UNLOCK_DOUBLE_KIT = "unlock_double_kit"
    UNLOCK_BLE_IBEACON = "unlock_ble_ibeacon"
    IBEACON_SCAN_MODE = "ibeacon_scan_mode"
    RSSI_SENSITIVITY_LEVEL = "rssi_sensitivity_level"
    AUTOLOCK_DELAY_LEVEL = "autolock_delay_level"
    IBEACON_SWITCH = "ibeacon_switch"
